...
public class UseBtn_LED {
    ...
    public static void main(String[] args) throws Exception{
        ...
        while(true){
            ...
            {
            	redBtnPress += 1;
                System.out.println("The red button has been pressed " + redBtnPress + " time(s)");
            }
            
            else if (greenButton.getState() == true)
            {
            	greenBtnPress += 1;
            	System.out.println("The green button has been pressed " + greenBtnPress + " time(s)");
            }
